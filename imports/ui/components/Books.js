    ...
    return (
      <div className="Books">
        ...
        <div className="tabs-data">
          <BooksList type="read" books={this.props.readBooks} isActive={ this.setActiveClassOnTab('read') } />
          <BooksList type="unread" books={this.props.unreadBooks} isActive={ this.setActiveClassOnTab('unread') } />
        </div>
      </div>
    );
  }
